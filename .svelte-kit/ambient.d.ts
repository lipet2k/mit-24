...
declare module '$env/static/private' {
	...
	export const npm_package_dependencies_bitcoin_qr: string;
	export const npm_package_dependencies_chart_js: string;
	export const npm_package_dependencies_dotenv: string;
	export const npm_package_dependencies_hardhat: string;
	export const npm_package_dependencies_svelte_chartjs: string;
	export const npm_package_dependencies__nomicfoundation_hardhat_toolbox: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_dependencies_bitcoin_qr: string;
		npm_package_dependencies_chart_js: string;
		npm_package_dependencies_dotenv: string;
		npm_package_dependencies_hardhat: string;
		npm_package_dependencies_svelte_chartjs: string;
		npm_package_dependencies__nomicfoundation_hardhat_toolbox: string;
